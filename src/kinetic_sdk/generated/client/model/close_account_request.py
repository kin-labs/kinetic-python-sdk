...
class CloseAccountRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, commitment, account, environment, index, mint, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, commitment, account, environment, index, mint, *args, **kwargs):  # noqa: E501
        """CloseAccountRequest - a model defined in OpenAPI
