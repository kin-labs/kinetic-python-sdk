...
class AirdropApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.airdrop_stats_endpoint = _Endpoint(
            settings={
                'response_type': (AirdropStats,),
                'auth': [],
                'endpoint_path': '/api/airdrop/stats',
                'operation_id': 'airdrop_stats',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def airdrop_stats(
        ...
        **kwargs
        ...
        >>> thread = api.airdrop_stats(async_req=True)
        >>> result = thread.get()
        ...
        return self.airdrop_stats_endpoint.call_with_http_info(**kwargs)
